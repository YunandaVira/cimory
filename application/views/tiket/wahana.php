...
<div class="container my-5">
    <h1 class="text-center text-success mb-4">Tiket Wahana</h1>

    <!-- Daftar Tiket Wahana -->
    <div class="row">
        <?php if (!empty($tiket_wahana)): ?>
            <?php foreach ($tiket_wahana as $tiket): ?>
                <div class="col-md-4 mb-3">
                    <div class="card shadow-sm">
                        <!-- Menampilkan gambar tiket wahana -->
                        <img src="<?= base_url('assets/images/' . $tiket->foto); ?>" class="card-img-top" alt="<?= $tiket->nama_tiket; ?>" style="height: 200px; object-fit: cover;">
                        
                        <div class="card-body">
                            <h5 class="card-title text-success"><?= $tiket->nama_tiket; ?></h5>
                            <p class="card-text">
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p class="text-center text-danger">Tiket wahana tidak tersedia.</p>
        <?php endif; ?>
    </div>
</div>
